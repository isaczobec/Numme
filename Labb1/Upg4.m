...
L = 1000; % observera att perioden verkar vara ca 500
vals2 = A2(day',L); % stoppa in x-värden i matrisen
...
start_guess = [8.5954,0.0012,0.1894,0.8652,1000]';
...
err_squared = @(root) sum(r(root(1),root(2),root(3),root(4),root(5)).^2)/n;
