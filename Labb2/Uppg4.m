...
f = @(t,y) [...
    y(3);...
    y(4);...
    -(k1*y(3)+k2*y(4))*abs(y(3))/m;...
    -(k1*y(3)+k2*y(4))*abs(y(4))/m - g;
    ];
...
for ti = 1:tol_steps
    ...
    a1 = pi/4*0.95; % gissa lite annan vinkel
...
a0 = pi/7; % i förra uppgiften givna startvinkel, gav x =~ 18
a1 = pi/8; % gissa lite annan vinkel
[t,x0] = trajectory_calculation(0.02,150,f,[0;h0;cos(a0)*v0;sin(a0)*v0]);
[t,x1] = trajectory_calculation(0.02,150,f,[0;h0;cos(a1)*v0;sin(a1)*v0]);
ai = a0;
aip = a1;
